...
first_user = User.create(name: 'Anyars Yussif', photo: 'https://e0.pxfuel.com/wallpapers/820/800/desktop-wallpaper-cute-black-girls-black-cartoon-characters-thumbnail.jpg', bio: 'Undisputed Queen of DIY', posts_counter: 0)
second_user = User.create(name: 'Yussif Gariba', photo: 'https://costumesheaven.b-cdn.net/wp-content/uploads/2022/05/Judy_is_awesome.PNG.jpg', bio: 'CEO Henna Hub UK', posts_counter: 0)
third_user = User.create(name: 'Gariba Sayibu', photo: 'https://kh.wiki.gallery/images/2/24/Nick_Wilde_KHUX.png', bio: 'Fox con artist from Zootopia', posts_counter: 0)
fourth_user = User.create(name: 'Salamatu Issahaku', photo: 'https://static.wikia.nocookie.net/zootopia/images/f/fa/Chief_Bogo.png/revision/latest?cb=20160211180005', bio: 'Police chief from Zootopia', posts_counter: 0)
fifth_user = User.create(name: 'Issahaku Ibrahim', photo: 'https://static.wikia.nocookie.net/disney/images/8/85/Profile_-_Bellwether_.jpeg/revision/latest?cb=20190312051343', bio: 'Sheep mayor from Zootopia', posts_counter: 0)
